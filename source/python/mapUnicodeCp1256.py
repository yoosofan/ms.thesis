...
mapUnicodeCp1256={
    ...
    0x2013  :  0x96, # EN DASH
    0x2014  :  0x97, # EM DASH
    0x06a9  :  0x98, # FARSI LETTER KEHEH
...
#    0x0626  :  0xc6, # ARABIC LETTER YEH WITH HAMZA ABOVE
    ...
    0x0643  :  0x98, # ARABIC LETTER KAF   0xdf  //changed by ahmad yosuefan 82/4/4
...
#    0x0649  :  0xed, # ARABIC LETTER ALEF MAKSURA  //changed by ahmad yousefan 82/4/4
    0x064a  :  0xed, # ARABIC LETTER YEH   0x06cc  :  0xed
    ...
    0x06a9  :  0x98     #kaf farsi  0xdf  //cahnged ahmad yousefan 83/4/4
}
mapCp1256Unicode={
    ...
    0xc6: 0x06cc,	# ARABIC LETTER YEH WITH HAMZA ABOVE 0x0626 changed by ahmad yousefan 82/06/28
    ...
    0xdf: 0x06a9,	# ARABIC LETTER KAF  #changed by ahmad yousefan 81/06/28 0x0643,	# ARABIC LETTER KAF
    ...
    0xec: 0x06cc,	# ARABIC LETTER ALEF MAKSURA  // changed ahmad yousefan 82/06/28 0x0649
    0xed: 0x06cc,	# FARSI  LETTER YEH // changed by ahmad yousefan 83/4/4
...
def cp1256Unicode(ch1):
    retVal1=''
    if ord(ch1)<=128:
        retVal1=unichr(ord(ch1)),
    else:
        retVal1=unichr(mapCp1256Unicode[ord(ch1)])
...
############################################################3333333333333333333333333333        
    ...
    for ch1 in s1:
        retVal1=retVal1+cp1256Unicode(ch1)
    return retVal1

def uniformUnicodeCharacter(ch1):
    num1=ord(ch1)
    retVal1=num1
    if num1==0x643: #kaf  to kehe
        retVal1=0x6a9
    elif (num1==0x626) or (num1==0x64a) or (num1==0x649): #yeh
        retVal1=0x6cc
    return unichr(retVal1)

def uniformUnicodeString(s1):
    retVal1=u''
    for ch1 in s1:
        retVal1 += uniformUnicodeCharacter(ch1)
    return retVal1
